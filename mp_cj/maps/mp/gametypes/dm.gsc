...
main()
{
	...
	level.onPlayerDamage = ::antiDamage;
	level.callbackPlayerDamage = ::antiDamage;
	...
	setscoreboardcolumns( "saves", "loads", "online time" ); 
}

antiDamage(eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, timeOffset) {
	return 0;
}
